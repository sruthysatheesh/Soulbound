...
contract SoulBoundSBT is ERC721URIStorage, Ownable {
    uint256 private _nextTokenId;

    // OZ v4: Ownable constructor takes no arguments — msg.sender is set as owner automatically
    constructor() ERC721("SoulBound Hacker Verification", "SoulBound") {}
    ...
    function _beforeTokenTransfer(
        ...
        if (from != address(0) && to != address(0)) {
            revert("SoulBoundSBT: Soulbound - cannot transfer.");
        }
    }
}
